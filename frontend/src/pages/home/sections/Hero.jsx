            ...
            <div className="max-w-7xl mx-auto px-6 py-28 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                ...
                <div className="space-y-10">
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold leading-[1.05] tracking-tight">
                        ...
                        <span className="text-primary">Invest Once. Pay the Rest After You’re Hired.</span>
                    </h1>

                    <p className="text-lg text-muted-foreground max-w-xl">
                        Structured career consulting, curated job opportunities, and direct recruiter access — designed to maximize your chances of
                    ...
                    <p className="text-xs text-muted-foreground max-w-xl">
                        A one-time registration fee applies. Post-placement charges are collected only after successful hiring and are aligned with
                        your first month’s salary. Full details are shared during onboarding.
                    </p>
                </div>
                ...
                <div className="relative">
                    ...
                    <div className="relative bg-card border rounded-2xl shadow-xl p-8 space-y-8">
                        <h3 className="text-lg font-semibold">How we help you get hired</h3>
                        ...
                        {[
                            ...
                            <div
                                ...
                                <div className="text-primary font-semibold text-lg">{item.step}</div>
                                <div>
