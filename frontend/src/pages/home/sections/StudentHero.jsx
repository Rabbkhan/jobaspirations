      ...
      <div className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8">
          ...
          <p className="text-lg text-muted-foreground max-w-xl">
            Continue your journey. Explore new opportunities, track your applications,
            and discover roles tailored to your skills.
          </p>

          <div className="flex flex-wrap gap-4 ">
            <Button size="lg" className="cursor-pointer" onClick={() => navigate("/jobs")}>Browse Jobs</Button>
            <Button size="lg" className="cursor-pointer" variant="outline" onClick={() => navigate("/applied_jobs")}>My Applications</Button>
          </div>
          ...
          <div className="relative bg-card border rounded-2xl shadow-xl p-8 space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-4 rounded-lg bg-muted">
                ...
                <Button variant="secondary" className="cursor-pointer" onClick={() => navigate("/applied_jobs")}>View</Button>
              </div>

              <div className="flex justify-between items-center p-4 rounded-lg bg-muted">
                <span>Saved Jobs</span>
                <Button variant="secondary" className="cursor-pointer" onClick={() => navigate("/saved-jobs")}>View</Button>
              </div>

              <div className="flex justify-between items-center p-4 rounded-lg bg-muted">
                <span>Profile Status</span>
                <Button variant="secondary" className="cursor-pointer" onClick={() => navigate("/profile")}>Complete Profile</Button>
              </div>
            </div>

            <Button className="w-full cursor-pointer"  onClick={() => navigate("/jobs")}>Start Exploring Now</Button>
          </div>
        </div>
      </div>
    </section>
