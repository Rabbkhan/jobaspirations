        ...
        <div className="max-w-7xl mx-auto px-6 py-32 grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-10">
            ...
            <p className="text-lg text-muted-foreground max-w-xl">
              We help startups and growing companies hire the right talent through
              curated candidates, expert screening, and hands-on hiring guidance.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button size="lg" variant="ghost" className="gap-2" onClick={scrollToProcess}>
          ...
          <div className="relative space-y-8 border-l pl-10">
            {[
              ...
              <div key={item.step} className="relative space-y-2">
                <span className="absolute -left-14 top-1 text-sm text-muted-foreground">
                  {item.step}
                </span>
        ...
        <div className="max-w-7xl mx-auto px-6 py-28 space-y-14">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            {[
              ...
              <div key={idx} className="p-6 rounded-2xl bg-background border shadow-sm space-y-3">
                <h3 className="text-xl font-semibold">{item.title}</h3>
      ...
      <section className="bg-muted">
        <div className="max-w-4xl mx-auto px-6 py-28 text-center space-y-6">
          ...
          <p className="text-lg text-muted-foreground">
            Tell us what you’re building — we’ll help you find the people.
          </p>
