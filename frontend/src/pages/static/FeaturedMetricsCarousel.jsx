...
const FeaturedMetricsCarousel = () => (
  <section className="py-16 bg-background">
    <div className="max-w-6xl mx-auto px-6 text-center">
      ...
      <Carousel opts={{ align: "start", loop: true }} plugins={[Autoplay({ delay: 3000 })]} className="w-full overflow-hidden">
              ...
              <CarouselItem key={idx} className="basis-full sm:basis-1/2 md:basis-1/3 lg:basis-1/4">
                <Card className="p-6 group cursor-pointer border rounded-xl shadow-sm bg-card transition-all hover:shadow-md hover:border-primary/50 hover:-translate-y-1">
                  <CardHeader className="p-0 space-y-3">
                    ...
                    <CardTitle className="text-lg font-semibold text-foreground">{metric.value} — {metric.title}</CardTitle>
