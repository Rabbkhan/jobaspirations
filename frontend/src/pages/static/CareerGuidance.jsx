    ...
    <div className="bg-background text-foreground">
      ...
      <section className="border-b">
        <div className="max-w-7xl mx-auto px-6 py-24 text-center space-y-6">
          ...
          <h1 className="text-4xl md:text-6xl font-bold">
            Get Expert Guidance to Build a Successful Career
          </h1>

          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Personalized mentoring, resume enhancement, interview preparation,
            and direct hiring support — everything you need to move ahead.
          </p>

          <div className="flex flex-wrap gap-4 justify-center pt-4">
            <Button size="lg" onClick={() => navigate("/book-session")}>
      ...
      <section className="py-16 border-b">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-muted-foreground text-center mt-2">
            Complete support to shape your professional journey
          </p>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="1">
              ...
              <AccordionContent>
                You can keep a free version + a premium consultation if needed.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="2">
              ...
              <AccordionContent>
                Yes, through verified recruiters and partnerships.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="3">
              ...
              <AccordionContent>
                Industry professionals, HR experts, and mentors.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
      ...
      <section className="py-16 text-center">
        ...
        <p className="text-muted-foreground mt-2">
          Get guidance that actually makes an impact.
        </p>
