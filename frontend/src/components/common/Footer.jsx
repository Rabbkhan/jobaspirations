    ...
    <footer className="bg-[#0F0F0F] text-gray-300 py-10 mt-10 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          {/* Brand */}
          <div>
            <h2 className="text-2xl font-bold text-white tracking-wide">Job Aspirations</h2>
            <p className="mt-3 text-sm text-gray-400 leading-relaxed">
              A modern job platform connecting students and recruiters.
              Build careers. Hire fast. Grow limitless.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="hover:text-white transition cursor-pointer">Find Jobs</li>
              <li className="hover:text-white transition cursor-pointer">Hire Talent</li>
              <li className="hover:text-white transition cursor-pointer">Upload Resume</li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="hover:text-white transition cursor-pointer">Career Tips</li>
