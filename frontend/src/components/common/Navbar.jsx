...
const studentLinks = [
  { to: "/applied_jobs", label: "Applied Jobs" },
];

const NAV_LINKS = user?.role === "student"
  ...
  return (
    <header className="w-full border-b bg-background sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        >
          <img src={Logo} alt="JobAspirations" className="w-40 sm:w-48 lg:w-60 h-auto object-contain" />
        </Link>
