...
const Profile = () => {
    ...
    const handleResumeUpload = (e) => setInput({ ...input, resumeFile: e.target.files[0] })

    const handlePhotoUpload = (e) => setInput({ ...input, profilePhotoFile: e.target.files[0] })
        ...
        <div className="max-w-6xl mx-auto my-10 px-4 space-y-10">
            ...
            <Card className="shadow-xl border relative">
                <Button
                    ...
                    {editing ? <XIcon className="w-5 h-5 text-red-600" /> : <PencilIcon className="w-5 h-5" />}
                </Button>
                                ...
                                <AvatarImage
                                    src={
                                        input.profilePhotoFile
                                            ...
                                            : input.profilePhoto || 'https://avatar.iran.liara.run/public/25'
                                    }
                                />
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <EditableField label="Profile Photo">
                            {editing ? (
                                ...
                                <p>{input.profilePhoto ? 'Photo uploaded' : 'Default photo in use'}</p>
                            )}
                        </EditableField>
