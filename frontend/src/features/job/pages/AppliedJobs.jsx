...
const AppliedJobs = () => {
    ...
    useEffect(() => {
        const fetchAppliedJobs = async () => {
            ...
            try {
                setLoading(true)
                const res = await axios.get(`${APPLICATIONS_API_END_POINT}/mine?page=${page}&limit=10`, { withCredentials: true })
    ...
    const filteredJobs = useMemo(() => {
        ...
        return statusFilter === 'All' ? jobapplied : jobapplied.filter((job) => job.status === statusFilter)
