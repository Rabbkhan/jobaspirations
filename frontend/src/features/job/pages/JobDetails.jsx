  ...
  <div className="max-w-4xl mx-auto">
    <Card className="shadow-xl rounded-2xl border border-border bg-background">
      ...
      <CardHeader className="space-y-4">
        ...
        <div className="flex flex-wrap gap-3">
          {[ 
            ...
            { icon: <CalendarIcon className="w-4 h-4" />, label: `Posted: ${new Date(singleJob?.createdAt).toLocaleDateString()}` },
      ...
      <CardContent className="space-y-8">
        ...
        {/* Job Description */}
        <div>
          <h3 className="text-xl font-semibold text-primary border-b border-primary/30 pb-1 mb-3">
            Job Description
          </h3>
          ...
          <Button
            ...
            className={`w-full md:w-auto rounded-lg text-white font-semibold transition-all ${
              isApplied
                ...
                : "bg-gradient-to-r from-primary to-blue-700 hover:scale-105"
            }`}
          >
