            ...
            <div className="max-w-5xl mx-auto px-4 space-y-8">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">Fill in the details below to publish a new job listing</p>
                    </div>
                ...
                <Card className="border shadow-sm rounded-2xl">
                    <form onSubmit={handleSubmit}>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2 w-full">
                                    ...
                                    <Select
                                        ...
                                        <SelectContent>
                                            {loading ? (
                                                <div className="p-3 text-sm text-muted-foreground text-center">Loading companies...</div>
                                            ) : allCompany?.length === 0 ? (
                        ...
                        <div className="p-6 space-y-6">
                            <h2 className="text-lg font-medium">Description & Requirements</h2>
