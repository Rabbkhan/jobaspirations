...
const Companycreate = () => {
    ...
    const RegisterNewCompany = async () => {
        try {
            ...
            toast.error(error.response?.data?.message || error.response?.data?.errors?.[0]?.msg || error.message || 'Something went wrong')
        } finally {
        ...
        <div className="p-6 flex justify-center">
            <Card className="w-full max-w-4xl rounded-xl border border-border shadow-sm bg-card">
                <CardHeader>
                    ...
                    <p className="text-muted-foreground text-sm">Fill out the details to add a new company to the system.</p>
                </CardHeader>
                ...
                <CardContent className="space-y-8">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <p className="text-sm text-muted-foreground">Recommended size: 300×300px (PNG or JPG).</p>
                        </div>{' '}
                        *
                    </div>
