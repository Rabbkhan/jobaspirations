        ...
        return (
            <Card className="w-full">
                ...
                <CardContent className="p-2">
                    <p className="text-sm text-muted-foreground">No latest blogs found.</p>
                </CardContent>
            </Card>
        )
    }
                    ...
                    <Link
                        ...
                        <Avatar className="w-12 h-12 rounded bg-gray-100 ">
                            {blog.featuredImage?.url ? (
                                ...
                                <span className="text-xs text-gray-500 flex items-center justify-center w-full h-full">No Image</span>
                            )}
                        </Avatar>
                        <div className="flex-1">
                            <p className="text-sm font-medium text-gray-800 line-clamp-2">{blog.title}</p>
